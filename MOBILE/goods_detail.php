...
<!--  주소검색 DIV 시작  -->
    ...
    <div id="post_div" style="display:none;position:fixed;width:100%;height:100%;top:0px;overflow:hidden;-webkit-overflow-scrolling:touch;z-index:999999999999">
      <img src="//i1.daumcdn.net/localimg/localimages/07/postcode/320/close.png" id="btnCloseLayer" style="cursor:pointer;position:absolute;right:0px;top:0px" onclick="closeDaumPostcode()" alt="닫기 버튼">
    </div>
<!--  주소검색 DIV 끝  -->
