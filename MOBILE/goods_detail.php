      ...
      <div class="content">
        ...
        <div class="info_block">
          <div class="input_one name clearfix">
            ...
            <div class="input"><input type="text" name="mb_name" id="mb_name" onblur="only_kor(this)" style="-webkit-appearance: none;-webkit-border-radius: 0;border:1px solid #d2d2d2;"></div>
          </div>
          <div class="input_one name clearfix">
            <div class="label">휴대폰번호</div>
            <div class="input"><input type="tel" name="mb_phone" id="mb_phone" onkeyup="only_num(this)" style="-webkit-appearance: none;-webkit-border-radius: 0;border:1px solid #d2d2d2;"></div>
          </div>
      ...
      <div class="content address">
        ...
        <div class="info_block">
          <div class="input_one add_num clearfix">
            ...
            <div class="input">
              <div class="inner clearfix">
                <div class="in"><input type="text" id="postcode1" readonly="readonly" size="5" style="-webkit-appearance: none;-webkit-border-radius: 0;border:1px solid #d2d2d2;"></div>
                <div class="dash">-</div>
                <div class="in"><input type="text" id="postcode2" readonly="readonly" size="5" style="-webkit-appearance: none;-webkit-border-radius: 0;border:1px solid #d2d2d2;"></div>
          ...
          <div class="input_one detail_num clearfix">
            ...
            <div class="input">
              <p class="first"><input type="text" id="addr1" readonly="readonly" style="-webkit-appearance: none;-webkit-border-radius: 0;border:1px solid #d2d2d2;"></p>
              <p><input type="text" id="addr2" style="-webkit-appearance: none;-webkit-border-radius: 0;border:1px solid #d2d2d2;"></p>
            </div>
          </div>
        </div>
        <div class="btn_block">
