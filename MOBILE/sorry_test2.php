...
<!doctype html>
  <html lang="en">
    <head>
      ...
      <meta property="og:image" content="http://www.tomorrowkids.or.kr/images/fb/jobimg_59.jpg" />
  ...
  <p>공유하기</p>
	<a href="#" onclick="fb_share_test2('<?=$goods_info['goods_name']?>','<?=$goods_info['goods_detail']?>','<?=$goods_info['goods_imgurl']?>','<?=$gubun?>');">facebook</a>
