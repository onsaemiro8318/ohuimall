...
<div id="page-wrapper">
  ...
  <!-- Page Heading -->
    <div class="row">
      <div class="col-lg-12">
        <h5><a href="download_excel.php?search_type=<?php echo $search_type?>&search_txt=<?php echo $search_txt?>&sDate=<?php echo $sDate?>&eDate=<?php echo $eDate?>">엑셀 파일로 다운받기</a></h5>
