...
<?php 
	...
	{
		$buyer_array[$i]['buyer_name']		= $data['buyer_name'];
		$buyer_array[$i]['buyer_phone']		= $data['buyer_phone'];
		$buyer_array[$i]['buyer_ipaddr']	= $data['buyer_ipaddr'];
		$buyer_array[$i]['buyer_goods']		= $data['buyer_goods'];
		$buyer_array[$i]['buyer_date']		= $data['buyer_date'];
		$buyer_array[$i]['buyer_gubun']		= $data['buyer_gubun'];
		$i++;
	}

	foreach ($buyer_array as $key => $val)
	{
?>
              <tr>
                ...
                <td><?php echo $val['buyer_ipaddr']?></td>
                <td><?php echo $val['buyer_goods']?></td>
                <td><?php echo $val['buyer_date']?></td>
                <td><?php echo $val['buyer_gubun']?></td>
              </tr>
<?php
	}
?>
