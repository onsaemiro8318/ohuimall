...
*/
	...
	$soldout_query 		= "SELECT goods_selcount, goods_total_stock FROM ".$_gl['goods_info_table']." WHERE idx = '2' ";
...
<html>
  <head>
    ...
    <meta property="og:url" content="http://ohuimall.co.kr/PC/goods_detail_2.php" />
