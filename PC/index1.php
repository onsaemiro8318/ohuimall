...
?>
            <div class="list">
              ...
              <p class="txt_name"><a href="goods_detail<?=$val['goods_idx']?>.php?goods_idx=<?=$val['goods_idx']?>"><img src="images/txt_product_name_<?=$val['goods_idx']?>.jpg" width="213" height="57" alt=""/></a></p>
