...
*/
	...
	$soldout_query 		= "SELECT goods_selcount, goods_total_stock FROM ".$_gl['goods_info_table']." WHERE idx = '6' ";
...
<html>
  <head>
    ...
    <meta property="og:url" content="http://ohuimall.co.kr/PC/goods_detail_6.php" />
    <meta property="og:image" content="http://www.ohuimall.co.kr/images/can_img_6.jpg">
...
<?
	...
	{
?>
              <img src="images/btn_buy_out.jpg"/>
<?
	}else{
?>
